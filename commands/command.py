...
from typeclasses.utils import capitalize
...
class CmdViewMemberships(default_cmds.MuxCommand):
    ...
    def func(self):
        ...
        if len(memberships) == 0:
            ...
            viewable_memberships = [capitalize(m, ["a", "an", "of", "the", "is"]) for m in memberships]
            caller.msg("[ %s ]" % list_to_string(viewable_memberships, endsep=None))